			...
			if ( (authcert == null) || (signcert == null) || (authReq == null) || (signReq == null) ) {
				...
				if (username != null) {
		            ...
		            if ( data.getStatus() != UserDataConstants.STATUS_NEW) {
		            	...
		            	Certificate authcertOut=pkcs10CertRequest(admin, getSignSession(), authPkcs10, username, data1.getPassword());
		            	...
		            	Certificate signcertOut=pkcs10CertRequest(admin, getSignSession(), signPkcs10, username, data1.getPassword());
